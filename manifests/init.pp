...
class nsd (
  ...
  Stdlib::Absolutepath $fragments_dir  = $nsd::params::fragments_dir,
  Array[String] $package_names         = $nsd::params::package_names,
  String $package_ensure               = $nsd::params::package_ensure,
  String $checkzone_cmd                = $nsd::params::checkzone_cmd,
  Variant[Boolean,String] $backup_zone = $nsd::params::backup_zone,
  ...
  Boolean $purge_fragments_dir         = $nsd::params::purge_fragments_dir,
) inherits nsd::params {
  contain nsd::install
  contain nsd::config
  contain nsd::exec
